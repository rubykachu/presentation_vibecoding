...
import { PROPOSAL_CONTENT, DESIGN_CONTENT, TASKS_CONTENT, SPEC_NAVIGATION, SPEC_LANDING } from "@/artifacts/specs";
        ...
        <div className="flex-1 overflow-auto p-0 bg-[#0a0a0a] relative group">
          ...
          <div className="absolute right-6 bottom-6 flex flex-col gap-2 z-30">
            <button
              ...
              className="p-2 bg-[#1c2527]/90 border border-[#2bcdee] text-[#2bcdee] rounded-lg hover:bg-[#2bcdee]/20 active:scale-95 transition-all shadow-[0_0_15px_rgba(43,205,238,0.3)] hover:shadow-[0_0_25px_rgba(43,205,238,0.5)] backdrop-blur-sm cursor-pointer"
            >
    ...
    >
      ...
      <div className="max-w-[1100px] mx-auto w-full z-10">
        ...
        >
          ...
          <div className="flex flex-col items-end max-md:items-center max-md:w-full gap-3">

            <button
              onClick={() => setIsOpenSpecModalOpen(true)}
              className="cursor-pointer px-4 py-2 font-mono text-xs font-bold tracking-widest uppercase flex items-center gap-2 bg-[#1c2527]/90 border border-[#2bcdee] text-[#2bcdee] rounded hover:bg-[#2bcdee]/20 active:scale-95 transition-all shadow-[0_0_15px_rgba(43,205,238,0.3)] hover:shadow-[0_0_25px_rgba(43,205,238,0.5)] backdrop-blur-sm"
            >
              <FileJson className="w-3.5 h-3.5" />
              OPEN PROJECT_ARTIFACTS
            </button>
          </div>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 w-full relative z-10">
          ...
          <div className="lg:col-span-4 flex flex-col justify-center gap-8">
            ...
            <a
              ...
              className="mt-4 inline-flex items-center gap-2 text-sm font-mono text-slate-400 hover:text-[#2bcdee] transition-colors uppercase tracking-wider group w-fit"
            >
